...
function analyseCorrespondingScripts() {
    ...
    (0, utilities_1.logInfo)(`${ejsViewFiles.length.toString().yellow} files found in ${constants_1.default.VIEWS_PATH.toString().yellow}.`);
        ...
        if (file.endsWith(".ejs")) {
            ...
            if (fs_1.default.existsSync(physicalScriptDirectoryPath)) {
                ...
                if (fs_1.default.existsSync(correspondingScriptPath)) {
                    ...
                    (0, utilities_1.logInfo)(`File '${pageName}' added to list of entries.`, "Script analyser");
                }
                else {
                    (0, utilities_1.logWarning)(`File '${pageName}' has no associated 'entry.ts' file located in ${physicalScriptDirectoryPath}.`, "Script analyser");
                }
            }
            else {
                (0, utilities_1.logWarning)(`File '${pageName}' has no associated script file in ${constants_1.default.SCRIPTS_PATH}.`);
            }
        }
    }
